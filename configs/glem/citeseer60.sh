#!/usr/bin/env bash
# GLEM configuration for 'citeseer' — LM=DeBERTa-base, GNN=RevGAT, logging to wandb.
...
DATASET_STR="citeseer60_TAG"
WANDB_NAME="citeseer60"
GLEM_ARGS="--dataset=${DATASET_STR} \
  ...
  --lm_eval_patience=120 --lm_init_ckpt=None --lm_label_smoothing_factor=0 \
