#!/usr/bin/env bash
# GLEM configuration for 'washington' — LM=DeBERTa-base, GNN=RevGAT, logging to wandb.
...
DATASET_STR="washington_TAG"
WANDB_NAME="washington"
GLEM_ARGS="--dataset=${DATASET_STR} \
  ...
  --lm_eval_patience=110 --lm_init_ckpt=None --lm_label_smoothing_factor=0 \
