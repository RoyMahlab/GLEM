#!/usr/bin/env bash
# GLEM configuration for 'wisconsin' — LM=DeBERTa-base, GNN=RevGAT, logging to wandb.
...
DATASET_STR="wisconsin_TAG"
WANDB_NAME="wisconsin"
GLEM_ARGS="--dataset=${DATASET_STR} \
  ...
  --lm_eval_patience=130 --lm_init_ckpt=None --lm_label_smoothing_factor=0 \
