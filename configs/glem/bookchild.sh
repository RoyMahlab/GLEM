#!/usr/bin/env bash
# GLEM configuration for 'bookchild' — LM=DeBERTa-base, GNN=RevGAT, logging to wandb.
...
DATASET_STR="bookchild_TAG"
WANDB_NAME="bookchild"
GLEM_ARGS="--dataset=${DATASET_STR} \
  ...
  --lm_eval_patience=46000 --lm_init_ckpt=None --lm_label_smoothing_factor=0 \
