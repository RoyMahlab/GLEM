#!/usr/bin/env bash
# GLEM configuration for 'sportsfit' — LM=DeBERTa-base, GNN=RevGAT, logging to wandb.
...
DATASET_STR="sportsfit_TAG"
WANDB_NAME="sportsfit"
GLEM_ARGS="--dataset=${DATASET_STR} \
  ...
  --lm_eval_patience=34600 --lm_init_ckpt=None --lm_label_smoothing_factor=0 \
