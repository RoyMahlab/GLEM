#!/usr/bin/env bash
# GLEM configuration for 'texas' — LM=DeBERTa-base, GNN=RevGAT, logging to wandb.
...
GLEM_ARGS="--dataset=${DATASET_STR} \
  ...
  --lm_eval_patience=90 --lm_init_ckpt=None --lm_label_smoothing_factor=0 \
