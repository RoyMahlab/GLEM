...
This project was jointly conducted with Central South University, where contributions were made by Hao under the supervision of Prof. Senzhang Wang.
...
/home/roymahlab/miniconda3/envs/ct/bin/python src/models/GLEM/trainGLEM.py \
  ...
  --lm_epochs=1 --lm_eq_batch_size=30 --lm_eval_patience=30460 --lm_init_ckpt=PrevEM \
  --lm_label_smoothing_factor=0 --lm_load_best_model_at_end=T --lm_lr=3e-05 --lm_model=Deberta \
  --lm_pl_ratio=0.1 --lm_pl_weight=0.5 --pl_filter=0.8 --pseudo_temp=0.2 --seed=0 --gpus=0
```
